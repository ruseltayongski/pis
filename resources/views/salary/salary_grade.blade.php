...
@section('content')
    <div class="page-content">
            ...
            <div class="col-xs-12 col-md-6">
                <label class="block clearfix">
                    <span class="block input-icon input-icon-right">
                        <input type="text" class="form-control" value="{{ Session::get('keyword') }}" id="search" name="keyword" placeholder="Search salary grade..." autofocus/>
                        <i class="ace-icon fa fa-search icon-on-right bigger-110"></i>
                    </span>
                </label>
            </div>
            <div class="col-xs-12 col-md-6">
                <a href="#document_form" data-link="{{ asset('salaryForm').'/'.$tranche }}" class="btn btn-info no-border btn-sm" data-dismiss="modal" data-backdrop="static" data-toggle="modal" data-target="#document_form">
        ...
        <div class="posts_all">
            <div class="row">
                <div class="col-xs-12">
                    @include('salary.salaryPagination')
                </div>
            </div>
        </div>
